...
public class TypescriptTreeStructureProvider implements TreeStructureProvider {
    private final Pattern namePattern =
            Pattern.compile("(.*)\\.(component|service|pipe|guard|directive|interceptor|module|actions|effects|reducer|selectors|state|resolver|datasource|controller)((\\.|\\..*\\.)(css|sass|scss|stylus|styl|less|html|haml|pug|ts|js|json))", Pattern.CASE_INSENSITIVE);
    @NotNull
    @Override
